...
public class mijavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MAIN", "CLASS", "PUBLIC", "STATIC", "VOID", "RETURN", "ID", "INT", "BOOLEAN", 
			"STRING", "INTEGER_LITERAL", "ADD", "SUB", "DIV", "MUL", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "LBRACK", "RBRACK", "SEMI", "COMMA", "DOT", "NOT", 
			"ASSIGN", "AND", "LT", "GT", "IF", "ELSE", "WHILE", "SOUT", "LENGTH", 
			"TRUE", "FALSE", "THIS", "NEW"
		};
	}
	...
	public mijavaLexer(CharStream input) {
		super(input);
